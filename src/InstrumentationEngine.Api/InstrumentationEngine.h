...
EXTERN_C const IID IID_IInstruction2;
    ...
    MIDL_INTERFACE("107E9783-358F-4083-B9B9-4353B9A5249E")
    IInstruction2 : public IInstruction
    {
    public:
        virtual IInstruction *STDMETHODCALLTYPE NextInstruction( void) = 0;
        
        virtual IInstruction *STDMETHODCALLTYPE PreviousInstruction( void) = 0;
    ...
    typedef struct IInstruction2Vtbl
    {
        ...
        IInstruction *( STDMETHODCALLTYPE *NextInstruction )( 
            __RPC__in IInstruction2 * This);
        
        IInstruction *( STDMETHODCALLTYPE *PreviousInstruction )( 
            __RPC__in IInstruction2 * This);
...
#define IInstruction2_NextInstruction(This)	\
    ( (This)->lpVtbl -> NextInstruction(This) ) 

#define IInstruction2_PreviousInstruction(This)	\
    ( (This)->lpVtbl -> PreviousInstruction(This) ) 
