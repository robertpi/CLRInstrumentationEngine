...
HRESULT MicrosoftInstrumentationEngine::CAppDomainInfo::FinishInitialization(_In_ ICorProfilerInfo* pRawICorProfilerInfo)
{
    ...
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::FinishInitialization"));
    ...
    if (!m_bIsInitialized)
    {
        C_LOGMESSAGE(_T("Initialized appdomain in CAppDomainInfo::FinishInitialization"));
    ...
    {
        C_LOGMESSAGE(_T("Renamed appdomain in CAppDomainInfo::FinishInitialization"));
    }

    C_LOGMESSAGE(_T("End CAppDomainInfo::FinishInitialization"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::AddAssemblyInfo"));
    ...
    C_LOGMESSAGE(_T("End CAppDomainInfo::AddAssemblyInfo"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::AssemblyInfoUnloaded"));
    ...
    C_LOGMESSAGE(_T("End CAppDomainInfo::AssemblyInfoUnloaded"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::AddModuleInfo"));
    ...
    C_LOGMESSAGE(_T("end CAppDomainInfo::AddModuleInfo"));
...
HRESULT MicrosoftInstrumentationEngine::CAppDomainInfo::ModuleInfoUnloaded(_In_ CModuleInfo* pModuleInfo)
{
    ...
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::ModuleInfoUnloaded"));
    ...
    C_LOGMESSAGE(_T("End CAppDomainInfo::ModuleInfoUnloaded"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::GetIsSystemDomain"));
    ...
    *pbValue = m_bIsSystemDomain;
    ...
    C_LOGMESSAGE(_T("End CAppDomainInfo::GetIsSystemDomain"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::GetIsSharedDomain"));
    ...
    *pbValue = m_bIsSharedDomain;
    ...
    C_LOGMESSAGE(_T("End CAppDomainInfo::GetIsSharedDomain"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::GetIsDefaultDomain"));
    ...
    *pbValue = m_bIsDefaultDomain;
    ...
    C_LOGMESSAGE(_T("End CAppDomainInfo::GetIsDefaultDomain"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::GetName"));
    ...
    *pbstrName = bstrName.Detach();
    ...
    C_LOGMESSAGE(_T("End CAppDomainInfo::GetName"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CAppDomainCollection::GetAssemblies"));
    ...
    *ppAssemblyInfos = (IEnumAssemblyInfo*)pEnumerator;
    ...
    C_LOGMESSAGE(_T("End CAppDomainCollection::GetAssemblies"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CAppDomainCollection::GetModules"));
    ...
    *ppModuleInfos = (IEnumModuleInfo*)pEnumerator;
    ...
    C_LOGMESSAGE(_T("End CAppDomainCollection::GetModules"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CAppDomainCollection::GetAssemblyInfoById"));
    ...
    *ppAssemblyInfo = NULL;
    ...
    {
        C_LOGMESSAGE(_T("CAppDomainCollection::GetAssemblyById - Failed to find specified assembly %04x"), assemblyID);
        return E_FAIL;
    }
    ...
    *ppAssemblyInfo = iter->second;
    ...
    C_LOGMESSAGE(_T("End CAppDomainCollection::GetAssemblyInfoById"));
...
HRESULT MicrosoftInstrumentationEngine::CAppDomainInfo::GetAssemblyInfosByName(_In_ BSTR pszAssemblyName, _Out_ IEnumAssemblyInfo** ppAssemblyInfos)
{
    ...
    *ppAssemblyInfos = NULL;
    ...
    C_LOGMESSAGE(_T("Starting CAppDomainCollection::GetAssemblyInfoByName"));
    ...
    *ppAssemblyInfos = pEnumerator.Detach();
    ...
    C_LOGMESSAGE(_T("End CAppDomainCollection::GetAssemblyInfoByName"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Begin CAppDomainInfo::GetModuleCount"));
    ...
    *pcModuleInfos = ((ULONG)m_moduleInfos.size());
    ...
    C_LOGMESSAGE(_T("End CAppDomainInfo::GetModuleCount"));
...
HRESULT MicrosoftInstrumentationEngine::CAppDomainInfo::GetModuleInfoById(_In_ ModuleID moduleId, _Out_ IModuleInfo** ppModuleInfo)
{
    ...
    *ppModuleInfo = NULL;
    ...
    C_LOGMESSAGE(_T("Starting CAppDomainCollection::GetModuleInfoById"));
    ...
    {
        C_LOGMESSAGE(_T("CAppDomainCollection::GetModuleById - Failed to find specified assembly %04x"), moduleId);
        return E_FAIL;
    }
    ...
    *ppModuleInfo = iter->second;
    ...
    C_LOGMESSAGE(_T("End CAppDomainCollection::GetModuleInfoById"));
...
HRESULT MicrosoftInstrumentationEngine::CAppDomainInfo::GetModuleInfosByMvid(_In_ GUID mvid, _Out_ IEnumModuleInfo** ppModuleInfo)
{
    ...
    *ppModuleInfo = NULL;
    ...
    C_LOGMESSAGE(_T("Starting CAppDomainCollection::GetModuleInfosByMvid"));
    ...
    *ppModuleInfo = (IEnumModuleInfo*)pEnumerator;
    ...
    C_LOGMESSAGE(_T("End CAppDomainCollection::GetModuleInfosByMvid"));
...
HRESULT MicrosoftInstrumentationEngine::CAppDomainInfo::GetModuleInfosByName(_In_ BSTR pszModuleName, _Out_ IEnumModuleInfo** ppEnumModuleInfo)
{
    ...
    *ppEnumModuleInfo = NULL;
    ...
    C_LOGMESSAGE(_T("Starting CAppDomainCollection::GetModuleInfosByName"));
    ...
    *ppEnumModuleInfo = pEnumerator.Detach();
    ...
    C_LOGMESSAGE(_T("End CAppDomainCollection::GetModuleInfosByName"));
