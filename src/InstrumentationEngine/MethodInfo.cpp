...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::Initialize"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::Initialize"));
    return S_OK;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetModuleInfo"));
    ...
    *ppModuleInfo = (IModuleInfo*)m_pModuleInfo;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetModuleInfo"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetName"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetName"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetFullName"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetFullName"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::ApplyIntermediateMethodInstrumentation"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::ApplyIntermediateMethodInstrumentation"));
    return hr;
}
...
HRESULT MicrosoftInstrumentationEngine::CMethodInfo::GetInstructions(_Out_ IInstructionGraph** ppInstructionGraph)
{
    ...
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetInstructions"));
    ...
    *ppInstructionGraph = m_pInstructionGraph;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetInstructions"));
...
HRESULT MicrosoftInstrumentationEngine::CMethodInfo::InitializeInstructionsAndExceptions()
{
    ...
    C_LOGMESSAGE(_T("CMethodInfo::InitializeInstructionsAndExceptions - Initializing Instruction Graph"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetClassId"));
    ...
    *pClassId = m_classId;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetClassId"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetFunctionId"));
    ...
    *pFunctionID = m_functionId;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetFunctionId"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetMethodDefToken"));
    IfNullRetPointer(pToken);

    *pToken = m_tkFunction;

    C_LOGMESSAGE(_T("End CMethodInfo::GetMethodDefToken"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetIsStatic"));
    ...
    *pbValue = IsFlagSet(m_methodAttr, mdStatic);
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIsStatic %04x"), *pbValue);
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetIsPublic"));
    ...
    *pbValue = IsFlagSet(m_methodAttr, mdPublic);
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIsPublic %04x"), *pbValue);
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetIsPrivate"));
    ...
    *pbValue = IsFlagSet(m_methodAttr, mdPrivate);
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIsPrivate %04x"), *pbValue);
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetIsPropertyGetter"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIsPropertyGetter %04x"), *pbValue);
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetIsPropertySetter"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIsPropertySetter %04x"), *pbValue);
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetIsFinalizer"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIsFinalizer %04x"), *pbValue);
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetIsConstructor"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIsConstructor %04x"), *pbValue);
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetIsStaticConstructor"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIsStaticConstructor %04x"), *pbValue);
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetDeclaringType"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetDeclaringType"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetReturnType"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetReturnType"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetCorSignature"));
    ...
    *pcbSignature = m_cbSigBlob;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetCorSignature"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetLocalVarSigToken"));
    IfNullRetPointer(pToken);
    ...
    *pToken = m_newCorHeader.LocalVarSigTok;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetLocalVarSigToken"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::SetLocalVarSigToken"));

    IfFailRet(InitializeHeader());

    m_newCorHeader.LocalVarSigTok = token;

    C_LOGMESSAGE(_T("End CMethodInfo::SetLocalVarSigToken"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetAttributes"));
    ...
    *pCorMethodAttr = m_methodAttr;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetAttributes"));
...
HRESULT MicrosoftInstrumentationEngine::CMethodInfo::GetRejitCodeGenFlags(_Out_ DWORD* pRefitFlags)
{
    ...
    *pRefitFlags = 0;
    ...
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetRejitCodeGenFlags"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetCodeRva"));
    ...
    *pRva = m_rva;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetCodeRva"));
    return hr;
}
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::MethodImplFlags"));
    ...
    *pCorMethodImpl = m_implFlags;
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::MethodImplFlags"));
    return hr;
}
...
HRESULT MicrosoftInstrumentationEngine::CMethodInfo::SetRejitCodeGenFlags(_In_ DWORD dwFlags)
{
    ...
    C_LOGMESSAGE(_T("Starting CMethodInfo::SetRejitCodeGenFlags"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetExceptionSection"));
    ...
    *ppExceptionSection = (IExceptionSection*)(m_pExceptionSection.p);
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetExceptionSection"));
...
{
    HRESULT hr = S_OK;
    C_LOGMESSAGE(_T("Starting CMethodInfo::GetInstructionFactory"));
    ...
    *ppInstructionFactory = (IInstructionFactory*)(m_pInstructionFactory.p);
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetInstructionFactory"));
        ...
        )
{
    ...
    C_LOGMESSAGE(_T("Start CMethodInfo::GetIntermediateRenderedFunctionBody"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::GetIntermediateRenderedFunctionBody"));
    ...
    )
{
    ...
    C_LOGMESSAGE(_T("Start CMethodInfo::SetFinalRenderedFunctionBody"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::SetFinalRenderedFunctionBody"));
...
HRESULT MicrosoftInstrumentationEngine::CMethodInfo::ApplyFinalInstrumentation()
{
    ...
    C_LOGMESSAGE(_T("Start CMethodInfo::ApplyFinalInstrumentation"));
    ...
    if (!IsRejit())
    {
        C_LOGMESSAGE(_T("CMethodInfo::ApplyFinalInstrumentation - Non-rejit case"));
    ...
    {
        C_LOGMESSAGE(_T("CMethodInfo::ApplyFinalInstrumentation - rejit case"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::ApplyFinalInstrumentation"));
    ...
    )
{
    ...
    C_LOGMESSAGE(_T("Start CMethodInfo::MergeILInstrumentedCodeMap"));
    ...
    C_LOGMESSAGE(_T("End CMethodInfo::MergeILInstrumentedCodeMap"));
